...
public final class ActivityChiSiamoBinding implements ViewBinding {
   ...
   */
  @Nullable
  public final ImageView imageViewSocio;
   ...
   */
  @Nullable
  public final TextView nomeDomenico;
   ...
   */
  @Nullable
  public final TextView nomeGiuseppe;
   ...
   */
  @Nullable
  public final TextView nomePeppe;
  ...
  private ActivityChiSiamoBinding(@NonNull View rootView, @NonNull View activityCs,
      ...
      @Nullable ImageView imageViewSocio, @NonNull View mappa, @Nullable TextView nomeDomenico,
      @Nullable TextView nomeGiuseppe, @Nullable TextView nomePeppe, @NonNull TextView testoTxt,
    ...
    this.imageViewSocio = imageViewSocio;
    this.mappa = mappa;
    this.nomeDomenico = nomeDomenico;
    this.nomeGiuseppe = nomeGiuseppe;
    this.nomePeppe = nomePeppe;
  ...
  public static ActivityChiSiamoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageViewSocio;
      ImageView imageViewSocio = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.nome_domenico;
      TextView nomeDomenico = ViewBindings.findChildViewById(rootView, id);

      id = R.id.nome_giuseppe;
      TextView nomeGiuseppe = ViewBindings.findChildViewById(rootView, id);

      id = R.id.nome_peppe;
      TextView nomePeppe = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityChiSiamoBinding(rootView, activityCs, cardImageDomenico, cardImageGiuseppe,
          ...
          imageViewSocio, mappa, nomeDomenico, nomeGiuseppe, nomePeppe, testoTxt, titolo2Txt,
          titoloSoci, titoloTxt, view, view2);
    }
